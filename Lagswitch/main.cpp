...
std::string rule_name = "LSbyLoathe";
std::string rule_name2 = "LSbyLoathe";
...
int main(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved)
{
    ...
    getoffsets();
    ifstream ins;
    ins.open(xor ("C:\\ls\\ins.txt"));
    if (!ins.is_open()) {
        HANDLE h_file = CreateFile(xor ("C:\\ls\\ins.txt"), GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        CloseHandle(h_file);
        ins_ok = 1;
    }
    ...
    Style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.480f, 0.494f, 0.482f, 1.000f);
    Style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.543f, 0.429f, 0.418f, 1.000f);
    Style.Colors[ImGuiCol_CheckMark] = ImVec4(0.569f, 0.449f, 0.433f, 1.000f);
    Style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.480f, 0.494f, 0.482f, 1.000f);
    Style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.569f, 0.549f, 0.533f, 1.000f);
    Style.Colors[ImGuiCol_Button] = ImVec4(0.137f, 0.137f, 0.141f, 0.549f);
    Style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.480f, 0.494f, 0.482f, 1.000f);
    Style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.569f, 0.549f, 0.533f, 1.000f);
    ...
    Style.Colors[ImGuiCol_Separator] = ImVec4(0.580f, 0.449f, 0.433f, 1.000f);
    Style.Colors[ImGuiCol_Tab] = ImVec4(0.137f, 0.137f, 0.141f, 0.549f);
    Style.Colors[ImGuiCol_TabHovered] = ImVec4(0.480f, 0.494f, 0.482f, 1.000f);
    Style.Colors[ImGuiCol_TabActive] = ImVec4(0.569f, 0.549f, 0.533f, 1.000f);
    Style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.137f, 0.137f, 0.141f, 0.549f);
    Style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.480f, 0.494f, 0.482f, 0.549f);
    ...
    Style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.039f, 0.039f, 0.037f, 1.000f);
    Style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.141f, 0.141f, 0.141f, 0.667f);
    Style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.680f, 0.294f, 0.282f, 1.000f);
    Style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.643f, 0.329f, 0.318f, 1.000f);
    Style.Colors[ImGuiCol_CheckMark] = ImVec4(0.669f, 0.249f, 0.333f, 1.000f);
    Style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.580f, 0.294f, 0.282f, 1.000f);
    Style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.769f, 0.249f, 0.333f, 1.000f);
    Style.Colors[ImGuiCol_Button] = ImVec4(0.137f, 0.137f, 0.141f, 0.549f);
    Style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.580f, 0.294f, 0.282f, 1.000f);
    Style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.669f, 0.249f, 0.333f, 1.000f);
    Style.Colors[ImGuiCol_Header] = ImVec4(0.141f, 0.141f, 0.141f, 0.667f);
    Style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.580f, 0.294f, 0.282f, 1.000f);
    Style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.669f, 0.249f, 0.333f, 1.000f);
    Style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.580f, 0.294f, 0.282f, 0.549f);
    Style.Colors[ImGuiCol_Separator] = ImVec4(0.780f, 0.249f, 0.333f, 1.000f);
    Style.Colors[ImGuiCol_Tab] = ImVec4(0.137f, 0.137f, 0.141f, 0.549f);
    Style.Colors[ImGuiCol_TabHovered] = ImVec4(0.580f, 0.294f, 0.282f, 1.000f);
    Style.Colors[ImGuiCol_TabActive] = ImVec4(0.669f, 0.249f, 0.333f, 1.000f);
    Style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.137f, 0.137f, 0.141f, 0.549f);
    ...
    **/
    ...
    while (!done)
    {
        ...
        {
            ImGui::Begin(xor ("Lagger by Loathe"), NULL, 18470);
            ...
            if (rlready == 0) {
                ...
                if (ins_ok == 1) {
                    ...
                    ImGui::BeginGroup();
                    {
                        ...
                        //ImGui::BeginGroup();
                        //{
                          //  ImGui::Text(xor ("Open instructions? (N/A Yet)"));
                          //  ImGui::Spacing();
                         //   if (ImGui::Button(xor ("Yes"), ImVec2(50, 20))) {
                         //       ShellExecute(NULL, "open", "", NULL, NULL, SW_SHOWNORMAL);
                         //       ins_ok = 0;
                         //   }                           
                         //   ImGui::SameLine();
                         //   if (ImGui::Button(xor ("No"), ImVec2(65, 20))) {
                         //       ins_ok = 0;
                         //   }
                       // }
                       // ImGui::EndGroup();
                    ...
                    ImGui::BeginGroup();
                    {
                        ...
                        if (button_menu_exit != 1) {
                            if (!menu_1)
                                ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.237f, 0.647f, 0.641f, 0.549f));
                            else
                                ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.669f, 0.449f, 0.433f, 1.000f));
                    ...
                    if (button_menu == 1 && button_menu_exit != 1) {
                        ...
                        ImGui::BeginGroup();
                        {
                            ImGui::BeginGroup();
                            {
                                ...
                                {
                                    ImGui::BulletText(xor ("Enable Tool:")); ImGui::SameLine();
                                    ImGui::Checkbox(xor ("###ActivateGLS"), &activate_gls);
                                    //ImGuiCustom::hotkey(xor ("Set Enable keybind:      "), activate_gls_bind, 110.0f);
                                   // TextHM(xor ("Toggle key to enable Switch."));
                                    ImGui::SameLine();
                                    ImGui::Text(xor ("   "));
                                    ImGui::Spacing();
                                    ImGui::Text(xor ("Lag mode:"));
                                    ImGui::SameLine();
                                    ImGui::Combo(xor ("###lagmode"), &mode_option, xor ("Lag Switch\0"));
                            ...
                            ImGui::BeginGroup();
                            {
                                ...
                                TextHM(xor ("Beep when lag is activated and deactivated."));
                            }
                            ImGui::EndGroup();
                                    ...
                                    ImGui::PushItemWidth(100);
                                    {
                                        if (mode_option == 0) {
                                            ...
                                            if (hold_key == 0 && eft_bypass == 0 || switch_packages != 1) {
                                                ...
                                                TextHM(xor ("Lag switch activated for a given number of ms (milliseconds).\nMin: 100\nMax: 10000"));
                                                ...
                                                //TextHM(xor ("Delay after lag switch (milliseconds).\nMin: 100\nMax: 1000"));
                                           ...
                                           // TextHM(xor ("Interval after deactivation of the lag in ms (milliseconds).\nMin: 10\nMax: 5000"));
                                        ...
                                        TextHM(xor ("Activate the lag by holding down a key."));
                                        ImGuiCustom::hotkey(xor ("Activation keybind:"), activate_duration_bind, 140.0f);
                                        TextHM(xor ("Lag activation key."));
                                    }
                                }
                                ImGui::EndGroup();
                                ImGui::SameLine();
                                    ...
                                    ImGui::PushItemWidth(100);
                                    {
                                        if (mode_option == 0 && switch_packages == 1) {
                                            ...
                                            if (inc_bypass_alt == 1) {
                                                ...
                                                TextHM(xor ("Bypass getting kicked from games."));
                                                if (eft_bypass == 1) {
                    ...
                    if (button_menu == 5 && button_menu_exit != 1) {
                        ...
                        ImGui::BeginGroup();
                        {
                            ...
                            ImGui::PushItemWidth(45);
                            {
                                ...
                                TextHM(xor ("Randomization of lag switch duration & fake lag delay.\nMax: 1000\nMin: 10"));
                        ...
                        {
                            ImGui::Text(xor ("      "));
                            ImGui::Text(xor ("Lagswitch version: %s"), version); ImGui::SameLine(); ImGui::TextDisabled(xor ("By Loathe"));
                            ImGui::Spacing();
                            ImGui::Spacing();
                            ImGui::Text(xor ("  ")); ImGui::SameLine();
                            //*if (ImGui::Button(xor ("instructions (Not Implemented Yet)"), ImVec2(180, 20))) {
                            //*    ShellExecute(NULL, "open", "", NULL, NULL, SW_SHOWNORMAL);
                            //*}
                            ImGui::Spacing();
                            ImGui::Spacing();
                            ...
                            if (ImGui::Button(xor ("Developer Github"), ImVec2(180, 20))) {
                                ShellExecute(NULL, "open", "https://github.com/Sinnisterly", NULL, NULL, SW_SHOWNORMAL);
                            }
                        }
                        ImGui::EndGroup();
                    }
